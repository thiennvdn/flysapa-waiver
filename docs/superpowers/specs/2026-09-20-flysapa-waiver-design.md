...
| Document extraction | Gemini `gemini-3.5-flash-lite` via REST (`generativelanguage.googleapis.com/v1beta`), called directly from the browser. No SDK. |
...
2. POST `…/models/gemini-3.5-flash-lite:generateContent?key=<apiKey>` with
